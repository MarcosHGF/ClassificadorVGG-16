...
input_folder_placa = 'Imagens'
input_folder_naoplaca = 'ImagensNaoPlaca'

# Caminhos para as pastas onde as imagens redimensionadas serão salvas
output_folder_placa = 'ImagensValidadas'
output_folder_naoplaca = 'ImagensValidadasNaoPlaca'

# Redimensionar as imagens
resize_images(input_folder_placa, output_folder_placa)
resize_images(input_folder_naoplaca, output_folder_naoplaca)
...
def predict_image(model, img_path):
    ...
    return "Nao Placa" if prediction[0] < 0.5 else "Placa"

# Listar todas as imagens redimensionadas na pasta de teste
img_files = []
for category in ['placa', 'naoplaca']:
